<div class="row mb-5">
    <div class="col-5 col-sm-3">
        <div class="nav flex-column nav-tabs h-100 overflow-hidden" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" id="vert-tabs-profile-tab" data-toggle="pill" href="#vert-tabs-coin_base" role="tab" aria-controls="vert-tabs-coin_base" aria-selected="false">{{trans('CoinBase')}}</a>
        </div>
    </div>
        ...
        <div class="tab-content" id="vert-tabs-tabContent">
            <div class="tab-pane text-left fade active show" id="vert-tabs-home" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="paypal_status">@lang('admin.form.status')</label>
                                <select class="form-control" name="paypal_status" id="paypal_status">
                                    <option {{isset($payment_gateway) && $payment_gateway->paypal_status=='inactive'?'selected':(old('paypal_status')=='inactive'?'selected':'')}} value="inactive">Inactive</option>
                                    <option {{isset($payment_gateway) && $payment_gateway->paypal_status=='active'?'selected':(old('paypal_status')=='active'?'selected':'')}} value="active">Active</option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="vert-tabs-profile" role="tabpanel" aria-labelledby="vert-tabs-profile-tab">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="stripe_status">@lang('admin.form.status')</label>
                            <select class="form-control" name="stripe_status" id="stripe_status">
                                <option {{isset($payment_gateway) && $payment_gateway->stripe_status=='inactive'?'selected':(old('stripe_status')=='inactive'?'selected':'')}} value="inactive">Inactive</option>
                                <option {{isset($payment_gateway) && $payment_gateway->stripe_status=='active'?'selected':(old('stripe_status')=='active'?'selected':'')}} value="active">Active</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane text-left fade " id="vert-tabs-flutter_wave" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="flutter_wave_status">@lang('admin.form.status')</label>
                            <select class="form-control" name="flutter_wave_status" id="flutter_wave_status">
                                <option {{isset($payment_gateway) && $payment_gateway->flutter_wave_status=='inactive'?'selected':(old('flutter_wave_status')=='inactive'?'selected':'')}} value="inactive">Inactive</option>
                                <option {{isset($payment_gateway) && $payment_gateway->flutter_wave_status=='active'?'selected':(old('flutter_wave_status')=='active'?'selected':'')}} value="active">Active</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="tab-pane text-left fade " id="vert-tabs-vogue_pay" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="vogue_pay_status">@lang('admin.form.status')</label>
                            <select class="form-control" name="vogue_pay_status" id="vogue_pay_status">
                                <option {{isset($payment_gateway) && $payment_gateway->vogue_pay_status=='inactive'?'selected':(old('vogue_pay_status')=='inactive'?'selected':'')}} value="inactive">Inactive</option>
                                <option {{isset($payment_gateway) && $payment_gateway->vogue_pay_status=='active'?'selected':(old('vogue_pay_status')=='active'?'selected':'')}} value="active">Active</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="tab-pane text-left fade " id="vert-tabs-iyzico" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="iyzico_status">@lang('admin.form.status')</label>
                            <select class="form-control" name="iyzico_status" id="iyzico_status">
                                <option {{isset($payment_gateway) && $payment_gateway->iyzico_status=='inactive'?'selected':(old('iyzico_status')=='inactive'?'selected':'')}} value="inactive">Inactive</option>
                                <option {{isset($payment_gateway) && $payment_gateway->iyzico_status=='active'?'selected':(old('iyzico_status')=='active'?'selected':'')}} value="active">Active</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="tab-pane text-left fade " id="vert-tabs-authorize_net" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="authorize_net_status">@lang('admin.form.status')</label>
                            <select class="form-control" name="authorize_net_status" id="authorize_net_status">
                                <option {{isset($payment_gateway) && $payment_gateway->authorize_net_status=='inactive'?'selected':(old('authorize_net_status')=='inactive'?'selected':'')}} value="inactive">Inactive</option>
                                <option {{isset($payment_gateway) && $payment_gateway->authorize_net_status=='active'?'selected':(old('authorize_net_status')=='active'?'selected':'')}} value="active">Active</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="tab-pane text-left fade " id="vert-tabs-coinpay" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="coinpay_status">@lang('admin.form.status')</label>
                            <select class="form-control" name="coinpay_status" id="coinpay_status">
                                <option {{isset($payment_gateway) && $payment_gateway->coinpay_status=='inactive'?'selected':(old('coinpay_status')=='inactive'?'selected':'')}} value="inactive">Inactive</option>
                                <option {{isset($payment_gateway) && $payment_gateway->coinpay_status=='active'?'selected':(old('coinpay_status')=='active'?'selected':'')}} value="active">Active</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="tab-pane text-left fade " id="vert-tabs-offline" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="online_status">@lang('admin.form.status')</label>
                            <select class="form-control" name="online_status" id="online_status">
                                <option {{isset($payment_gateway) && $payment_gateway->online_status=='inactive'?'selected':(old('online_status')=='inactive'?'selected':'')}} value="inactive">Inactive</option>
                                <option {{isset($payment_gateway) && $payment_gateway->online_status=='active'?'selected':(old('online_status')=='active'?'selected':'')}} value="active">Active</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="tab-pane text-left fade " id="vert-tabs-coin_base" role="tabpanel" aria-labelledby="vert-tabs-coin_base">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>{{trans('admin.settings.api_key')}}</label>
                            <input
                                value="{{isset($payment_gateway->coin_base_api_key)?$payment_gateway->coin_base_api_key:''}}"
                                type="text" name="coin_base_api_key"
                                class="form-control"
                                placeholder="{{trans('admin.settings.api_key')}}">
                        </div>
                        <div class="form-group">
                            <label for="coin_base_status">@lang('admin.form.status')</label>
                            <select class="form-control" name="coin_base_status" id="coin_base_status">
                                <option {{isset($payment_gateway) && $payment_gateway->coin_base_status=='inactive'?'selected':(old('coin_base_status')=='inactive'?'selected':'')}} value="inactive">Inactive</option>
                                <option {{isset($payment_gateway) && $payment_gateway->coin_base_status=='active'?'selected':(old('coin_base_status')=='active'?'selected':'')}} value="active">Active</option>
                            </select>
                        </div>
                    </div>
